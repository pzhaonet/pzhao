...
头像下的社交按钮是在`config.toml`里设置的，只需添加个`[[params.social]]`就可以了，图标去[fa](https://fortawesome.github.io/Font-Awesome/icons/)或[ai](https://jpswalsh.github.io/academicons/)两个包的主页找便是。 除了RSS，我顺便把自己卡拉OK的录音和腾讯视频也加进去了，代码如下：
