...
下面是 [bookdown+](https://github.com/dapengde/bookdown-plus) 的简介和快速使用方法。

# 背景 {intro}

[R bookdown+](https://github.com/dapengde/bookdown-plus)，听起来像是跟R[@R-base]的扩展包`bookdown`[@R-bookdown]有关吧? 
...
[R bookdown+](https://github.com/dapengde/bookdown-plus)用起来就容易多了，只需在一个叫做`_runme.R`的文件里设置好书名、作者，选好模板，binggo！就可以开始放心写自己的文字了。

功能扩展，操作简化，这就是[R bookdown+](https://github.com/dapengde/bookdown-plus)。
