...
这两个概念我从前学过，但从来没用过。于是查了一下[维基百科](https://zh.wikipedia.org/wiki/%E5%87%A0%E4%BD%95%E5%B9%B3%E5%9D%87%E6%95%B0):
...
而几何标准差的解释是[这样](https://zh.wikipedia.org/wiki/%E5%B9%BE%E4%BD%95%E6%A8%99%E6%BA%96%E5%B7%AE)的：
...
那么，这两组数据的合集 $(x_i, x_2, ... x_n, y_i, y_2, ... y_n)$ 的几何平均值 $G_{x,y}$ 和几何标准差$\sigma_{x,y}$如何计算？
...
$\sigma_y = \exp(\sqrt{\frac{\sum_{i = 1}^{n} (\ln \frac{y_i}{G_y})^2)}{m}}) \Rightarrow \Sigma(\ln \frac{y_i}{G_y}) ^2= (\ln(\sigma_y))^2 \cdot m$ (5)
