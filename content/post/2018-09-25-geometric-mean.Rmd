...
- 第 1 组数据是 $(x_1, x_2, ... x_n)$, 其几何平均值是 $G_x$，几何标准差是 $\sigma_x$。
- 第 2 组数据是 $(y_1, y_2, ... y_n)$, 其几何平均值是 $G_y$，几何标准差是 $\sigma_y$。

那么，这两组数据的合集 $(x_1, x_2, ... x_n, y_1, y_2, ... y_n)$ 的几何平均值 $G_{x,y}$ 和几何标准差$\sigma_{x,y}$如何计算？
...
在本页的公式上面鼠标点右键，就可以复制公式代码贴到别的地方了。